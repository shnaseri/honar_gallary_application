...
class ImageSerializer {
  ...
  bool operator ==(Object other) =>
      ...
      other is ImageSerializer && other.id == id && other.image == image;

  @override
  int get hashCode =>
      // ignore: unnecessary_parenthesis
      (id == null ? 0 : id.hashCode) + (image == null ? 0 : image.hashCode);
  ...
  static List<ImageSerializer> listFromJson(
    dynamic json, {
    bool emptyIsNull,
    bool growable,
  }) =>
  ...
  static Map<String, ImageSerializer> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      json.cast<String, dynamic>().forEach(
          (key, dynamic value) => map[key] = ImageSerializer.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of ImageSerializer-objects as value to a dart map
  static Map<String, List<ImageSerializer>> mapListFromJson(
    dynamic json, {
    bool emptyIsNull,
    bool growable,
  }) {
