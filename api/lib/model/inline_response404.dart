...
class InlineResponse404 {
  ...
  bool operator ==(Object other) =>
      ...
      other is InlineResponse404 && other.detail == detail;
  ...
  static List<InlineResponse404> listFromJson(
    dynamic json, {
    bool emptyIsNull,
    bool growable,
  }) =>
      json is List && json.isNotEmpty
          ? json
              .map(InlineResponse404.fromJson)
  ...
  static Map<String, InlineResponse404> mapFromJson(dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      json.cast<String, dynamic>().forEach(
          (key, dynamic value) => map[key] = InlineResponse404.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of InlineResponse404-objects as value to a dart map
  static Map<String, List<InlineResponse404>> mapListFromJson(
    dynamic json, {
    bool emptyIsNull,
    bool growable,
  }) {
