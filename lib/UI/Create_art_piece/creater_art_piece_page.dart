...
import 'create_page_list.dart';

// import 'package:image_picker/image_picker.dart';

class CreateArtPiece extends StatefulWidget {
  const CreateArtPiece({Key? key}) : super(key: key);

  @override
  _CreateArtPieceState createState() => _CreateArtPieceState();
}

class _CreateArtPieceState extends State<CreateArtPiece> {
  // String? _name;
  // String? _description;
