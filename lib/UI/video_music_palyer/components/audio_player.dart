...
Future<void> initDuration() async {
  int durationInt = await audioPlayer.getDuration();
  durationMusic = Duration(milliseconds: durationInt);
  print("1111");
  print(durationInt);
}
...
class AudioPlayerPageState extends State<AudioPlayerPage> {
  ...
  late StreamSubscription<Duration> _mediaListener;
